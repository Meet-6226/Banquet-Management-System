    ...
    return (
        <aside className="w-[260px] bg-[#2B1512] text-gray-300 flex flex-col h-screen fixed left-0 top-0 overflow-y-auto">
            ...
            <div className="p-6 flex items-center gap-3">
                ...
                <div>
                    <h1 className="text-[22px] font-bold text-white font-playfair leading-none mb-1 tracking-wide">BanquetPro</h1>
                    <p className="text-[10px] text-[#8e8484] font-semibold tracking-[0.2em] uppercase">Owner Control</p>
                </div>
            </div>
            ...
            <div className="px-4 py-6 border-t border-white/10 space-y-4">
                ...
                <div className="mt-8 flex items-center gap-3 px-4">
                    ...
                    <div className="overflow-hidden flex-1">
                        ...
                        <p className="text-[9px] text-[#8e8484] uppercase tracking-[0.15em] font-semibold mt-0.5">{user?.role?.replace("_", " ") || "Admin"}</p>
                    </div>
